...
G = model.generator_mwm3(z_dim=z_dim_num, output_channel=img_channel, input_size=input_size, c_d1=c_d_num, c_d2=c_d2_num)  
D = model.discriminator_mwm3(input_channel=img_channel, output_dim=1, input_size=input_size, c_d1=c_d_num, c_d2=c_d2_num)
